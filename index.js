...
const year =   artists.slice().sort((a, b)=> b.years - a.years)
...
// */
// function removeArtist(arr, x) {

// const rem = artists.shift();
...
//   let lotsOfArt = artists.filter(artists => artists.paintings > 100);
